...
The platforms and tools may change, but the core problem doesn’t: building software for real users, under constraints that actually matter. That kind of work changes how you approach problems — you stop guessing and start accounting for consequences.

I've stayed current through contract work, independent projects, and formal study. I spent nine months at a game studio, where I trained in Unity and contributed to a tactical RPG in development before the studio closed. I've been making and sharing games of my own design since 2020. I balance my project work with household management and caregiving.

I'm currently completing an Intermediate Data Analytics certification program, picking up tools like R, Tableau, Power BI, and modern SQL to complement the kind of work I’ve been doing for years.

# What I'm Looking For
I’m most interested in **systems design** — working out rules, models, and emergent behavior, then turning them into something people actually use. That could mean game systems, simulation tools, data pipelines, or something altogether new to me yet still adjacent.

I'm open to software development and data roles where deep experience and careful thinking are assets. I work well independently and value environments where thoughtful problem-solving and clear decision-making are important.

I'm not looking for a stepping stone. I'm looking for *work worth doing*.

# Technologies & Tools
- **Languages:** C#, Python, SQL, Visual FoxPro
- **Platforms & Tools:** Unity 2D, ESRI MapObjects, GitHub, QGIS
- **Domains:** Ecological simulation, GIS, inventory systems, statistical modeling, game design
...
- I care about clean code, expressive APIs, and simple interfaces for complicated tasks.
